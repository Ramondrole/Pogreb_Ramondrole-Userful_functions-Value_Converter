const BACK_LINK = 'https://ramondrole.github.io/Pogreb_Ramondrole-Userful_functions/';
document.getElementById('backLink').href = BACK_LINK;
...
function updateOutput(inputElem, fromSelect, toSelect, outputElem, convTable, isTemperature = false) {
    ...
    outputElem.value = result.toFixed(10).replace(/\.?0+$/, '');
}
